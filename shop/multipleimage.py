...
with open("scraped.csv", "w", newline= "\n", encoding="utf-8") as csvfile:
    ...
    csvwriter.writerow(["Category", "Title","Brand", "Image","Image1","Image2","Image3", "Link", "Price", "Description", "Model", "RAM", "Generation", "Display", "Storage", "Processor", "Touch Screen", "Graphics", "Resolution", "Color", "Warranty", "Insurance"])  # Updated header row
